...
###################################################################
##    l = ["./data/car_1600.mp4", "./data/yolov3.mp4",
##         "./data/traffic.mp4", "./data/road_traffic.mp4"]
##    vids = get_video_caps(l)
##
##
##    ######## Threaded Function
####    frames_gen = get_frames(vids)
####    counter = 0
####
####    st = time.time()
...
##
##    ######### Thread Body
####    thread_body = FramesThreadBody(vids)
####
####    frames_thread = Thread(target=thread_body)
####    frames_thread.setDaemon(True)
####    frames_thread.start()
####
####    counter = 0
####
...
##
##    ######### Threaded Generator
##    threaded_gen = ThreadedGenerator(vids).__iter__()
##    c = 0
##
##    frames = next(threaded_gen)
##
##    st = time.time()
##    for frames in threaded_gen:
####    while True:
...
##
##        if frames is None:
##            print(f"Done fetching frames...")
##            stop_video_caps(vids)
##            print(f"Video sources stopped!")
##            break
##        
##        if c % 100 == 0:
