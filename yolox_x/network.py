...
class IEModel:
    ...
    def completion_callback(self, infer_request, id_):
        self.outputs[id_] = infer_request.get_tensor(self.output_tensor_name).data[:]
    ...
    def forward_async(self, img, req_id):
        input_data = {self.input_tensor_name: img}
